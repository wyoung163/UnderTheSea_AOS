...
{
    var datas = mutableListOf<RecordInfo>()
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.activity_record_preview_recyclerview, parent, false)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: RecordInfo){
            ...
            title.setOnClickListener {
                //상세 조회를 위해 클릭한 기록의 식별자 함께 넘겨주기
                val intent1 = Intent(context, MainActivity3::class.java)
                intent1.putExtra("record_id", item.record_id)
