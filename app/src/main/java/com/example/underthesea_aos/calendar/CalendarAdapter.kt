...
import com.example.underthesea_aos.calendar.FurangCalendar
    ...
    inner class CalendarItemHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
        ...
        fun bind(data: Int, position: Int, context: Context) {
            ...
            if (position < firstDateIndex || position > lastDateIndex) {
                itemCalendarDateText.setTextAppearance(androidx.constraintlayout.widget.R.style.Base_TextAppearance_AppCompat_Light_Widget_PopupMenu_Small)
